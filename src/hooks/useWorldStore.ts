...
export const useCharacters = () => useSelector(() => worldStore.characters.get());
export const useNations = () => useSelector(() => worldStore.nations.get());
export const useTechniques = () => useSelector(() => worldStore.techniques.get());
export const useIngredients = () => useSelector(() => worldStore.ingredients.get());
...
export const useEvent = (id: string) => useSelector(() => worldStore.events.find((e: any) => e.id.get() === id)?.get());
export const useCharacter = (id: string) => useSelector(() => worldStore.characters.find((c: any) => c.id.get() === id)?.get());